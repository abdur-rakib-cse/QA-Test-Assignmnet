...
class TestMysuite1():
    ...
    def test_myTest1(self):
        ...
        self.driver.set_window_size(942, 727)
        self.driver.find_element(By.CSS_SELECTOR, ".pop-up-alert > button").click()
        assert self.driver.switch_to.alert.text == "Press a button!"
        self.driver.switch_to.alert.accept()
        self.driver.find_element(By.ID, "fname").click()
        self.driver.find_element(By.ID, "fname").send_keys("Abdur")
        self.driver.find_element(By.ID, "lname").click()
        self.driver.find_element(By.ID, "lname").send_keys("Rakib")
        ...
        self.driver.find_element(By.NAME, "Options").send_keys("Akasita")
        self.driver.find_element(By.ID, "favcolor").click()
        self.driver.find_element(By.ID, "favcolor").send_keys("#ffca0a")
        self.driver.find_element(By.ID, "day").click()
        self.driver.find_element(By.ID, "day").click()
        self.driver.find_element(By.ID, "day").send_keys("2000-11-11")
        ...
        self.vars["win849"] = self.wait_for_window(2000)
        self.vars["root"] = self.driver.current_window_handle
        self.driver.switch_to.window(self.vars["win849"])
